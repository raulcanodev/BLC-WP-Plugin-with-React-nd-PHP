...
<div <? echo $block_wrapper_attributes; ?> >
	...
	<div class="curve bottom-curve" style="style="display: <? echo $attributes['enableBottomCurve'] ? "block" : "none" ?>;  transform:<? echo $bottomTransform ?>; height:<? echo $attributes['bottomHeight']?>px;">
